 ...
 * @version 
 */
@Entity(namespace = "iuap-quickstart",name = "collegeType")
@Table(name = "collegeType")
public class CollegeType extends BaseEntity{
    ...
    private java.lang.String student_num;
	...
	/**
	 * 属性 student_num的Getter方法.属性名：学生数量
	 *  创建日期:2019-3-14
	 * @return java.lang.String
	 */
	public java.lang.String getStudent_num () {
		return student_num;
	}
	   
	/**
	 * 属性student_num的Setter方法.属性名：学生数量
	 * 创建日期:2019-3-14
	 * @param newStudent_num java.lang.String
	 */
	public void setStudent_num (java.lang.String newStudent_num ) {
	 	this.student_num = newStudent_num;
	} 	 
