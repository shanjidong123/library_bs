define(['text!pages/queryFine/queryfine.html','css!pages/queryFine/queryfine','pages/queryFine/meta','uuigrid'],function(html){
	var init=function(element){

		var listUrl = ctx+'/payFine/BorrowList';
		...
		var viewModel = {
				...
				pageSize:5,
				totleCount:0,
				dt1: new u.DataTable(queryfineMeta),
